...
from .views import product_list_view, product_detail_view, product_create_view , product_delete_view, product_edit_view, product_update_view,admin_page,admin_product_list_view,add_products_view, cart_view, cart_delete_view, cart_checkout_view,bought_list_view,is_credit_card_saved
...
urlpatterns = [
    ...
    path("cart_checkout", cart_checkout_view, name = "cart_checkout"),
    path("bought-list", bought_list_view, name = "bought_list"),
    path("is-saved" , is_credit_card_saved, name = "is-saved"),
